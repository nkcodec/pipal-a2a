...
export default function (pi: ExtensionAPI) {
  ...
  pi.registerTool({
    ...
    promptGuidelines: [
      ...
      "",
      "[MemPalace] BEFORE delegating: call mempalace_search({ query: <project>, wing: \"wing_a2a\", room: \"shared\" }) to check for prior work.",
      "[MemPalace] BEFORE delegating: call mempalace_kg_query({ entity: <project> }) to find known facts about the project.",
      "[MemPalace] AFTER delegation completes: call mempalace_add_drawer({ wing: \"wing_a2a\", room: \"shared\", content: <status> }) to update shared/project-status.",
